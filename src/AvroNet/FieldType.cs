...
internal sealed record class FieldType(string Name, FieldType? TypeArg = null, string? LogicalType = null)
{
    ...
    public static FieldType LogicalDecimal { get; } = new("Avro.AvroDecimal", null, "decimal");
    public static FieldType LogicalDecimalNullable { get; } = new("Avro.AvroDecimal?", null, "decimal");

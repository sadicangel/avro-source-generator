...
using Xunit;
using VerifyCS = AvroSourceGenerator.UnitTests.Verifiers.CSharpSourceGeneratorVerifier<AvroSourceGenerator.AvroSourceGenerator>;
...
public class AvroSchemaGeneratorUnitTests
{
    private const string Attribute = $$""""
        {{AvroSourceGenerator.AutoGeneratedComment}}
